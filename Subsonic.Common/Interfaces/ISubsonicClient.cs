...
namespace Subsonic.Common.Interfaces
{
    ...
    public interface ISubsonicClient<T>
    {
        ...
        /// <param name="cancelToken">The CancellationToken associated with a managed CancellationTokenSource.</param>
        /// <returns cref="bool">True on success</returns>
		Task<bool> CreateUserAsync(string username, string password, string email, bool? ldapAuthenticated = null, bool? adminRole = null, bool? settingsRole = null, bool? streamRole = null, bool? jukeboxRole = null, bool? downloadRole = null, bool? uploadRole = null, bool? playlistRole = null, bool? coverArtRole = null, bool? commentRole = null, bool? podcastRole = null, string musicFolderId = null, CancellationToken? cancelToken = null);

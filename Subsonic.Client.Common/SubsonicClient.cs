...
namespace Subsonic.Client
{
    public class SubsonicClient<T> : ISubsonicClient<T>
    {
        ...
        public virtual async Task<SearchResult> SearchAsync(string artist = null, string album = null, string title = null, string any = null, int? count = null, int? offset = null, long? newerThan = null)
        {
            var parameters = SubsonicParameters.Create();
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> CreatePlaylistAsync(string playlistId = null, string name = null, IEnumerable<string> songId = null)
        {
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> UpdatePlaylistAsync(string playlistId, string name = null, string comment = null, IEnumerable<string> songIdToAdd = null, IEnumerable<string> songIndexToRemove = null)
        {
            var parameters = SubsonicParameters.Create(SubsonicParameterType.List);
            parameters.Add(Constants.Name, name);
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> DeletePlaylistAsync(string id)
        {
            var parameters = SubsonicParameters.Create();
            parameters.Add(Constants.Id, id, true);
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> ScrobbleAsync(string id, bool? submission = null, long? time = null)
        {
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> ChangePasswordAsync(string username, string password)
        {
            var parameters = SubsonicParameters.Create();
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> StarAsync(IEnumerable<string> id = null, IEnumerable<string> albumId = null, IEnumerable<string> artistId = null)
        {
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> UnStarAsync(IEnumerable<string> id = null, IEnumerable<string> albumId = null, IEnumerable<string> artistId = null)
        {
            if (id == null && albumId == null && artistId == null)
                throw new SubsonicApiException("You must provide one of id, albumId or artistId");
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> SetRatingAsync(string id, int rating)
        {
            var parameters = SubsonicParameters.Create();
            parameters.Add(Constants.Id, id, true);
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> CreateUserAsync(string username, string password, bool? ldapAuthenticated = null, bool? adminRole = null, bool? settingsRole = null, bool? streamRole = null, bool? jukeboxRole = null, bool? downloadRole = null, bool? uploadRole = null, bool? playlistRole = null, bool? coverArtRole = null, bool? commentRole = null, bool? podcastRole = null)
        {
            var parameters = SubsonicParameters.Create();
            parameters.Add(Constants.Username, username, true);
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> AddChatMessageAsync(string message)
        {
            var parameters = SubsonicParameters.Create();
        ...
        public virtual async Task<AlbumList> GetAlbumListAsync(AlbumListType type, int? size = null, int? offset = null, CancellationToken? cancelToken = null)
        {
            var methodApiVersion = Versions.Version120;
        ...
        /// <param name="cancelToken"></param>
        /// <returns>AlbumList</returns>
        public virtual async Task<AlbumList2> GetAlbumList2Async(AlbumListType type, int? size = null, int? offset = null, CancellationToken? cancelToken = null)
        {
            var albumListTypeName = type.GetXmlEnumAttribute();
        ...
        /// <returns>bool</returns>
        public virtual async Task<bool> JukeboxControlAsync(JukeboxControlAction action, int? index = null, float? gain = null, IEnumerable<string> id = null)
        {
        ...
        public virtual async Task<Podcasts> GetPodcastsAsync(CancellationToken? cancelToken = null)
        {

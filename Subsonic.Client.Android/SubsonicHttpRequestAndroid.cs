...
{
    public class SubsonicHttpRequestAndroid<T> : SubsonicHttpRequest<T>
    {
        protected SubsonicServerAndroid SubsonicServerAndroid { get; set; }

        public SubsonicHttpRequestAndroid(SubsonicServerAndroid subsonicServer) : base(subsonicServer)
        {
        ...
        protected override HttpWebRequest BuildRequest(Uri requestUri, string method = HttpMethod.Post)
        {
            ...
            request.Proxy = SubsonicServerAndroid.Proxy;
